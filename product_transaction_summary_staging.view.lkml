view: product_transaction_summary_staging {
  sql_table_name: substitutableProduct.product_transaction_summary_staging ;;
  ...
  dimension: total_subcategory_frequency_purchase {
    type: number
    sql: ${TABLE}.total_subcategory_frequency_purchase ;;
  }
